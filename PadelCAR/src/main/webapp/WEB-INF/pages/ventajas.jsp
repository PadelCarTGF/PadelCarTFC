...
<div class="row">
	<div class="col-sm-12">
		<section id="site-content">
			...
			<h2> VENTAJAS DEL CLUB </h2>
					<p> Impresionante complejo deportivo donde podrás entrenar en las mejores pistas de Pádel .</p>
					
					<h3>¡Disfruta del pádel!</h3>
					
					<h5> Reseva ahora mismo <br> Sin cuotas de permanencia </h5>
					
					<p> bla  bla bla.........PONEMOS LO QUE VEAMOS........</p>
